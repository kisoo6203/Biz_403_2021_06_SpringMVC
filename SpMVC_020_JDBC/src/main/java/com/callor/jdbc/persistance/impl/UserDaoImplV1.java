...
public class UserDaoImplV1 implements UserDao{
	...
	public UserVO findById(String username) {
		...
		UserVO userVO = (UserVO)
				jdbcTemplate.query(sql, new BeanPropertyRowMapper<UserVO>(UserVO.class));
		return userVO;
	}
	...
	public int insert(UserVO vo) {
		...
		// JdbcTemplate으로 query를 전송할 때
		// 전달할 값이 몇개 안될 때는 Object[] 배열로 만들지 않아도 된다
