...
<script src="${rootPath}/static/js/book_input.js?ver=2021-06-22-009"></script>
<body>
	...
	<section class="main_sec">
		<form id="book_input" method="POST">
			<fieldset>
				...
				<div>
					<label>가격</label> <input name="bk_price" value="0" id="bk_price"
						placeholder="">
				</div>
				<div>
					<label>페이지수</label> <input name="bk_pages" value="0" id="bk_pages"
						placeholder="">
				</div>
			</fieldset>
			<div class="btn_box">
				<button type="button" class="btn_save_book">도서등록</button>
				<button type="reset" class="btn_reset_book">새로작성</button>
				<button type="button" class="btn_list_book">리스트로</button>
			</div>
		</form>
	</section>
