...
public class StudentServiceImplV1 implements StudentService{
	...
	public String makeStNum() {
		...
		// 현재날짜에서 연도 문자열 생성하기		
		Date date = new Date(System.currentTimeMillis()); // Ctrl + Shift + o = util로 가져오기
	 ...
	 * 
	 * 이런 상황을 방지하기 위하여
	 * 업무 단위를 transeation이라는 단위로 묶고
	 * 
	 * 모든 업무가 완료되면 데이터를Commit(실제저장)하고
	...
	public String scoreInput(ScoreInputVO scInputVO) {
		...
		*/
		 ...
		 * 모든 Insert Or Update가 Rollback 되어버렸다		
		 */
