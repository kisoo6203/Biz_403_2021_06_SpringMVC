...
<link href="${rootPath}/static/css/join.css?ver=2021-07-20-004"	rel="stylesheet" />
<body>
	<figure class="clip">
		<figcaption>
			<div>
	...
	<form method="POST"	class="form_join">
		<fieldset>
			...
			<tr>
				...
				<td><input type="text" id="us_name" class="textForm" placeholder="이름을 입력..." name="us_name" />
			</tr>
			<tr>
				<th class="first"><label for="us_id">ID</label></th>
				<td><input type="text" id="us_id" class="textForm" placeholder="ID를 입력..." name="us_id" />
					<button id="id_check" type="button">중복확인</button>
				</td>
			</tr>
			<tr>
				<th><label for="user_pwd">PW</label></th>
				<td><input type="password" id="us_pw" class="textForm" placeholder="비밀번호를 입력..." name="us_pw" /></td>
			</tr>
			<tr>
